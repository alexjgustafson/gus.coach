...
<div class="w-full border-opacity-50 py-12 px-6 lg:px-48 bg-neutral">
  <div class="container mx-auto prose text-neutral-content">
    ...
    <p>Starting Strength trains the Squat, Press, Deadlift, Bench Press, and Power Clean. Gus will teach you how to safely and effectively perform each of these lifts.</p>
...
<div class="w-full border-opacity-50 py-12">
  <div class="container mx-auto px-2">
    ...
    <div class="flex flex-col lg:flex-row px-2 lg:px-24 xl:px-48">
      <figure class="flex-none flex flex-col items-center pb-12">
